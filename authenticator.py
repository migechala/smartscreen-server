...
GOOGLE_CLIENT_ID = "644333397224-kb8kne2l5bc8r2qof9aeak4dtg8brhkv.apps.googleusercontent.com"
...
def callback():
    ...
    with open (request.remote_addr + ".json", "w") as token:
...
@login_is_required
def protected_area():
    return f"Hello {session['name']}! You've successfully logged in. You can go ahead and close this tab now!"
